...
This code outputs optical SFH comparison plots, saved to the working directory
'''
#------------------------------------------------------------------------------------------------------
#Packages importing
import csv
...
plt.clf()
for i in range(16):
	add_sub_plot(i+1,desired[i]) #add our subplots with desired lines (calls routine add subplot)

plt.savefig('SFH_Comp_optical.pdf')
