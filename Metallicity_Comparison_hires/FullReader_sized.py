...
numplots = 18
width = 3 
def add_sub_plot_subsolar(eline,sub_num, set):

	plt.subplot(numplots/width,4,sub_num)
...
#SOLAR
def add_sub_plot_solar(eline,sub_num, set):
...
#SUPERSOLAR
def add_sub_plot_supersolar(eline,sub_num,set):
...
for i in range(3):
	...
	for j in subplots_ref2:
		add_sub_plot_subsolar(counter,j,i)
		add_sub_plot_solar(counter,j+1,i)
		add_sub_plot_supersolar(counter,j+2,i)
		counter += 1
	print "plot saving"
	plt.savefig(("Metallicity_%d.pdf")%i)
	print "plot saved"
	plt.clf()
