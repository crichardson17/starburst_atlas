...
numFiles = 5 #change this if you have more/less files
...
def add_sub_plot(sub_num, elinesplot):
	...
	plt.annotate(headers[line[elinesplot][sub_num-1]], xy=(3.8,9.5),  xytext=(3.8,9.5), fontsize = 10)

	plt.annotate("Dust-free 0.2 Z$\odot$", xy=(2.8,8.5),  xytext=(2.8,8.5), fontsize = 10)
