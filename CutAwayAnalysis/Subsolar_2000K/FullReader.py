...
def add_sub_plot(sub_num, elinesplot):
	...
	plt.annotate(headers[line[elinesplot][sub_num-1]], xy=(0,8.5),  xytext=(3,8.5), fontsize = 10)
	...
	#axis limits
	yt_min = 8 ; yt_max = 16; xt_min = 0; xt_max = 10 
...
for j in range (len(z_total)): 
	...
	add_patches(ax1)
	#plt.show()
	plt.savefig(("Full_lines_%daxis.pdf")%j)
