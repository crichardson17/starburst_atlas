...
sp1.text(.5,.9,"Padova Track Instantaneous",horizontalalignment="center", transform = sp1.transAxes)
...
sp2.text(.5,.9,"Padova Track Continuous",horizontalalignment="center", transform = sp2.transAxes)
...
sp3.text(.5,.9,"Geneva Track Instantaneous with Rotation- 0.002 Metallicity",horizontalalignment="center", transform = sp3.transAxes)
...
sp4.text(.5,.9,"Geneva Track Continuous with Rotation- 0.002 Metallicity",horizontalalignment="center", transform = sp4.transAxes)
...
sp5.text(.5,.9,"Geneva Track Instantaneous with Rotation- 0.008 Metallicity",horizontalalignment="center", transform = sp5.transAxes)
...
sp6.set_yticklabels([])
plt.xlabel('Energy (eV)', fontsize = 15)
sp6.text(.5,.9,"Geneva Track Continuous with Rotation- 0.008 Metallicity",horizontalalignment="center", transform = sp6.transAxes)
